...
<html lang="en">
	...
	<head><base href="">
		...
		<link href="{{ asset('admin/assets/plugins/custom/leaflet/leaflet.bundle.css?v=7.0.4') }}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
				...
				<div class="aside aside-left d-flex flex-column" id="kt_aside">
					...
					<div class="aside-nav d-flex flex-column align-items-center flex-column-fluid pt-7">
						...
						<ul class="nav flex-column">
							...
							<li class="nav-item mb-5" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Tipo de fragancia">
								<a href="{{ url('/admin/type/index') }}" class="nav-link btn btn-icon btn-text-white btn-hover-text-white btn-lg">
		...
		<ul class="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-3 mt-4">
			...
			<li class="nav-item mb-2" data-toggle="tooltip" title="Layout Builder" data-placement="left">
				<a class="btn btn-sm btn-icon btn-bg-light btn-icon-primary btn-hover-primary" href="https://keenthemes.com/metronic/preview/demo4/builder.html" target="_blank">
					<i class="flaticon2-gear"></i>
				</a>
			</li>
			<!--end::Item-->
